...
Browse [LeRobot](https://github.com/huggingface/lerobot) ⭐ 27,230 | 🐛 862 | 🌐 Python | 📅 2026-09-05 to see how robot datasets, policies, training, and evaluation are structured in practice.
...
* [PyBullet](https://github.com/bulletphysics/bullet3) ⭐ 14,714 | 🐛 424 | 🌐 C++ | 📅 2025-10-22 — Open-source physics engine (Bullet) with Python bindings, popular for prototyping and RL.
...
* [Brax](https://github.com/google/brax) ⭐ 3,230 | 🐛 109 | 🌐 Jupyter Notebook | 📅 2026-08-06 — Differentiable, accelerator-native physics engine designed for high-throughput RL experimentation.
...
* [AgiBot World](https://github.com/OpenDriveLab/AgiBot-World) ⭐ 3,166 | 🐛 38 | 🌐 Python | 📅 2026-05-29 — Large-scale dataset designed to train and evaluate robot foundation models.
* [CALVIN ABC-D](https://github.com/mees/calvin) ⭐ 983 | 🐛 52 | 🌐 Python | 📅 2025-09-08 — Language-conditioned manipulation dataset for long-horizon policy training and evaluation.
...
* [ManiSkill Benchmark](https://github.com/haosulab/ManiSkill) ⭐ 3,292 | 🐛 136 | 🌐 Python | 📅 2026-08-04 — Manipulation benchmark suite with scalable GPU simulation and reproducible baselines.
* [CALVIN](https://github.com/mees/calvin) ⭐ 983 | 🐛 52 | 🌐 Python | 📅 2025-09-08 — Benchmark for long-horizon, language-conditioned manipulation.
...
* [LeRobot Evaluation Scripts](https://github.com/huggingface/lerobot) ⭐ 27,230 | 🐛 862 | 🌐 Python | 📅 2026-09-05 — Practical evaluation tooling for imitation-learning and policy-regression checks.
* [Bench2Drive](https://github.com/Thinklab-SJTU/Bench2Drive) ⭐ 1,933 | 🐛 57 | 🌐 Python | 📅 2026-08-11 — Closed-loop evaluation protocol for end-to-end driving policies.
* [nuPlan Devkit](https://github.com/motional/nuplan-devkit) ⭐ 1,033 | 🐛 100 | 🌐 Python | 📅 2025-08-27 — End-to-end planning evaluation stack with documented metrics and simulation loops.
* [CARLA ScenarioRunner](https://github.com/carla-simulator/scenario_runner) ⭐ 681 | 🐛 179 | 🌐 Python | 📅 2026-09-02 — Scenario-based closed-loop evaluation harness for safety-critical driving behaviors.
* [RoboHive](https://github.com/vikashplus/robohive) ⭐ 631 | 🐛 26 | 🌐 Python | 📅 2026-09-02 — Benchmarking suite with standardized tasks and scoring across manipulation and locomotion.
...
* [Robotic World Model (ETH RSL)](https://github.com/leggedrobotics/robotic_world_model) ⭐ 671 | 🐛 4 | 🌐 Python | 📅 2026-04-08 — Learned world model for legged robots from ETH Zurich's Robotic Systems Lab; companion [lite variant](https://github.com/leggedrobotics/robotic_world_model_lite) ⭐ 236 | 🐛 0 | 🌐 Python | 📅 2026-04-08 for lighter-weight experimentation.
...
* [Contact-GraspNet](https://github.com/NVlabs/contact_graspnet) ⭐ 527 | 🐛 25 | 🌐 Python | 📅 2024-11-21 — Grasp pose generation directly from partial point clouds.
...
* [MuJoCo Menagerie](https://github.com/google-deepmind/mujoco_menagerie) ⭐ 3,919 | 🐛 41 | 🌐 Python | 📅 2026-09-04 — Curated high-quality robot models for repeatable locomotion research.
* [RSL-RL](https://github.com/leggedrobotics/rsl_rl) ⭐ 2,947 | 🐛 8 | 🌐 Python | 📅 2026-08-31 — Fast PPO implementation from ETH Zurich tuned for legged-robot RL on GPU simulators.
...
* [OmniSafe](https://github.com/PKU-Alignment/omnisafe) ⭐ 1,150 | 🐛 29 | 🌐 Python | 📅 2025-03-17 — Open-source safe-RL training framework with strong baseline implementations.
* [Safe Control Gym](https://github.com/utiasDSL/safe-control-gym) ⭐ 915 | 🐛 6 | 🌐 Python | 📅 2026-04-29 — Benchmark suite for safe learning-based control with constraints and disturbances.
...
* [Safety-Gymnasium](https://github.com/PKU-Alignment/safety-gymnasium) ⭐ 580 | 🐛 16 | 🌐 Python | 📅 2026-07-21 — Modern safe-RL benchmark suite extending Safety Gym with richer constraints and tasks.
* [VerifAI](https://github.com/BerkeleyLearnVerify/VerifAI) ⭐ 219 | 🐛 14 | 🌐 Python | 📅 2026-07-05 — Falsification and formal-analysis toolkit for autonomy and cyber-physical systems.
...
* [rosbag2](https://github.com/ros2/rosbag2) ⭐ 437 | 🐛 126 | 🌐 C++ | 📅 2026-09-05 — Standard ROS 2 recording and replay pipeline for debugging and incident analysis.
...
* [LeRobot Tutorials](https://github.com/huggingface/lerobot) ⭐ 27,230 | 🐛 862 | 🌐 Python | 📅 2026-09-05 - Getting started with robot learning using Hugging Face's framework.
...
* [DexUMI Code & Data](https://github.com/real-stanford/DexUMI) ⭐ 258 | 🐛 7 | 🌐 C | 📅 2026-04-18 - Code and datasets for the Dex-UMI dexterous manipulation benchmark.
...
* [LeRobot Hardware](https://github.com/huggingface/lerobot) ⭐ 27,230 | 🐛 862 | 🌐 Python | 📅 2026-09-05 - Reference designs for low-cost robot arms.
* [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,311 | 🐛 84 | 📅 2026-08-05 - Open-source anthropomorphic robot arm.
...
* [Awesome Generative AI](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,561 | 🐛 643 | 📅 2026-09-04 - Broader generative AI resources.
* [Awesome Robotics](https://github.com/kiloreux/awesome-robotics) ⭐ 7,009 | 🐛 40 | 📅 2024-09-22 - General robotics resources.
* [Awesome LLM Robotics](https://github.com/GT-RIPL/Awesome-LLM-Robotics) ⭐ 4,460 | 🐛 10 | 📅 2026-07-17 - LLM/VLM applications in robotics.
* [Awesome Robotics Libraries](https://github.com/jslee02/awesome-robotics-libraries) ⭐ 3,034 | 🐛 18 | 🌐 Python | 📅 2026-08-25 - Robotics software libraries.
* [Awesome Embodied Agent](https://github.com/zchoi/Awesome-Embodied-Robotics-and-Agent) ⭐ 1,867 | 🐛 2 | 📅 2026-08-14 - Embodied AI with VLMs and LLMs.
* [Awesome Deep RL](https://github.com/kengz/awesome-deep-rl) ⭐ 900 | 🐛 2 | 📅 2025-07-13 - Deep reinforcement learning resources.
...
* [Bipedal Robot Learning Collection](https://github.com/zita-ch/bipedal-robot-learning-collection) ⭐ 463 | 🐛 2 | 📅 2026-04-06 - Curated bipedal/humanoid robot-learning papers with a sim-to-real focus.
* [Awesome World Models](https://github.com/operator22th/awesome-world-models-for-robots) ⭐ 140 | 🐛 0 | 📅 2026-03-30 - World models for robotics.
* [Awesome AI Scientists](https://github.com/natnew/Awesome-AI-Scientists) ⭐ 18 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-04 - AI scientist systems for literature intelligence, hypothesis generation, experiment planning, and scientific communication.
* [Awesome Agentic AI Security](https://github.com/natnew/Awesome-Agentic-AI-Security) ⭐ 16 | 🐛 9 | 🌐 Astro | 📅 2026-07-24 - Security research, threat models, defenses, and governance for agentic AI systems.
* [Awesome Agentic Engineering](https://github.com/natnew/Awesome-Agentic-Engineering) ⭐ 4 | 🐛 6 | 📅 2026-08-25 - Agentic AI architectures, frameworks, memory, evaluation, and safety.
