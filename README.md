...
Browse [LeRobot](https://github.com/huggingface/lerobot) ⭐ 26,661 | 🐛 783 | 🌐 Python | 📅 2026-08-15 to see how robot datasets, policies, training, and evaluation are structured in practice.
...
* [PyBullet](https://github.com/bulletphysics/bullet3) ⭐ 14,673 | 🐛 423 | 🌐 C++ | 📅 2025-10-22 — Open-source physics engine (Bullet) with Python bindings, popular for prototyping and RL.
...
* [Brax](https://github.com/google/brax) ⭐ 3,216 | 🐛 113 | 🌐 Jupyter Notebook | 📅 2026-08-06 — Differentiable, accelerator-native physics engine designed for high-throughput RL experimentation.
...
* [AgiBot World](https://github.com/OpenDriveLab/AgiBot-World) ⭐ 3,137 | 🐛 38 | 🌐 Python | 📅 2026-05-29 — Large-scale dataset designed to train and evaluate robot foundation models.
* [CALVIN ABC-D](https://github.com/mees/calvin) ⭐ 967 | 🐛 53 | 🌐 Python | 📅 2025-09-08 — Language-conditioned manipulation dataset for long-horizon policy training and evaluation.
* [RLDS](https://github.com/google-research/rlds) ⚠️ Archived — Standardized format and tooling for logged trajectories used across robot-learning datasets.
...
* [ManiSkill Benchmark](https://github.com/haosulab/ManiSkill) ⭐ 3,225 | 🐛 134 | 🌐 Python | 📅 2026-08-04 — Manipulation benchmark suite with scalable GPU simulation and reproducible baselines.
* [CALVIN](https://github.com/mees/calvin) ⭐ 967 | 🐛 53 | 🌐 Python | 📅 2025-09-08 — Benchmark for long-horizon, language-conditioned manipulation.
...
* [LeRobot Evaluation Scripts](https://github.com/huggingface/lerobot) ⭐ 26,661 | 🐛 783 | 🌐 Python | 📅 2026-08-15 — Practical evaluation tooling for imitation-learning and policy-regression checks.
* [Bench2Drive](https://github.com/Thinklab-SJTU/Bench2Drive) ⭐ 1,923 | 🐛 57 | 🌐 Python | 📅 2026-08-11 — Closed-loop evaluation protocol for end-to-end driving policies.
* [nuPlan Devkit](https://github.com/motional/nuplan-devkit) ⭐ 1,025 | 🐛 100 | 🌐 Python | 📅 2025-08-27 — End-to-end planning evaluation stack with documented metrics and simulation loops.
* [CARLA ScenarioRunner](https://github.com/carla-simulator/scenario_runner) ⭐ 676 | 🐛 180 | 🌐 Python | 📅 2026-07-29 — Scenario-based closed-loop evaluation harness for safety-critical driving behaviors.
* [RoboHive](https://github.com/vikashplus/robohive) ⭐ 630 | 🐛 26 | 🌐 Python | 📅 2026-08-14 — Benchmarking suite with standardized tasks and scoring across manipulation and locomotion.
...
* [Robotic World Model (ETH RSL)](https://github.com/leggedrobotics/robotic_world_model) ⭐ 669 | 🐛 3 | 🌐 Python | 📅 2026-04-08 — Learned world model for legged robots from ETH Zurich's Robotic Systems Lab; companion [lite variant](https://github.com/leggedrobotics/robotic_world_model_lite) ⭐ 233 | 🐛 0 | 🌐 Python | 📅 2026-04-08 for lighter-weight experimentation.
...
* [Contact-GraspNet](https://github.com/NVlabs/contact_graspnet) ⭐ 520 | 🐛 25 | 🌐 Python | 📅 2024-11-21 — Grasp pose generation directly from partial point clouds.
...
* [MuJoCo Menagerie](https://github.com/google-deepmind/mujoco_menagerie) ⭐ 3,822 | 🐛 49 | 🌐 Python | 📅 2026-08-09 — Curated high-quality robot models for repeatable locomotion research.
* [legged\_gym](https://github.com/leggedrobotics/legged_gym) ⭐ 3,087 | 🐛 59 | 🌐 Python | 📅 2025-05-29 — Reference Isaac Gym/Isaac Lab environments for legged locomotion research.
* [RSL-RL](https://github.com/leggedrobotics/rsl_rl) ⭐ 2,885 | 🐛 9 | 🌐 Python | 📅 2026-07-20 — Fast PPO implementation from ETH Zurich tuned for legged-robot RL on GPU simulators.
* [FLD — Fourier Latent Dynamics (MIT Biomimetics)](https://github.com/mit-biomimetics/fld) ⭐ 367 | 🐛 0 | 🌐 Python | 📅 2024-06-13 — Periodic motion latent representation for learning agile, natural-looking legged locomotion (ICLR 2024).
...
* [CASSI (Max Planck / Martius Lab)](https://github.com/martius-lab/cassi) ⭐ 55 | 🐛 0 | 🌐 Python | 📅 2024-04-06 — Self-supervised adversarial imitation of unlabeled mixed motions for versatile quadruped skill control (ICRA 2023).
...
* [OmniSafe](https://github.com/PKU-Alignment/omnisafe) ⭐ 1,148 | 🐛 30 | 🌐 Python | 📅 2025-03-17 — Open-source safe-RL training framework with strong baseline implementations.
* [Safe Control Gym](https://github.com/utiasDSL/safe-control-gym) ⭐ 907 | 🐛 6 | 🌐 Python | 📅 2026-04-29 — Benchmark suite for safe learning-based control with constraints and disturbances.
...
* [Safety-Gymnasium](https://github.com/PKU-Alignment/safety-gymnasium) ⭐ 579 | 🐛 16 | 🌐 Python | 📅 2026-07-21 — Modern safe-RL benchmark suite extending Safety Gym with richer constraints and tasks.
* [VerifAI](https://github.com/BerkeleyLearnVerify/VerifAI) ⭐ 218 | 🐛 15 | 🌐 Python | 📅 2026-07-05 — Falsification and formal-analysis toolkit for autonomy and cyber-physical systems.
...
* [ros2\_control](https://control.ros.org/) — Standardized hardware abstraction and controller framework for production robot actuation.
...
* [rosbag2](https://github.com/ros2/rosbag2) ⭐ 432 | 🐛 120 | 🌐 C++ | 📅 2026-08-14 — Standard ROS 2 recording and replay pipeline for debugging and incident analysis.
...
* [LeRobot Tutorials](https://github.com/huggingface/lerobot) ⭐ 26,661 | 🐛 783 | 🌐 Python | 📅 2026-08-15 - Getting started with robot learning using Hugging Face's framework.
...
* [DexUMI Code & Data](https://github.com/real-stanford/DexUMI) ⭐ 254 | 🐛 7 | 🌐 C | 📅 2026-04-18 - Code and datasets for the Dex-UMI dexterous manipulation benchmark.
...
* [LeRobot Hardware](https://github.com/huggingface/lerobot) ⭐ 26,661 | 🐛 783 | 🌐 Python | 📅 2026-08-15 - Reference designs for low-cost robot arms.
* [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,092 | 🐛 82 | 📅 2026-08-05 - Open-source anthropomorphic robot arm.
...
* [Awesome Generative AI](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,497 | 🐛 572 | 📅 2026-08-03 - Broader generative AI resources.
* [Awesome Robotics](https://github.com/kiloreux/awesome-robotics) ⭐ 6,891 | 🐛 37 | 📅 2024-09-22 - General robotics resources.
* [Awesome LLM Robotics](https://github.com/GT-RIPL/Awesome-LLM-Robotics) ⭐ 4,449 | 🐛 10 | 📅 2026-07-17 - LLM/VLM applications in robotics.
* [Awesome Robotics Libraries](https://github.com/jslee02/awesome-robotics-libraries) ⭐ 3,013 | 🐛 14 | 🌐 Python | 📅 2026-08-06 - Robotics software libraries.
* [Awesome Embodied Agent](https://github.com/zchoi/Awesome-Embodied-Robotics-and-Agent) ⭐ 1,849 | 🐛 3 | 📅 2026-08-14 - Embodied AI with VLMs and LLMs.
* [Awesome Deep RL](https://github.com/kengz/awesome-deep-rl) ⭐ 898 | 🐛 2 | 📅 2025-07-13 - Deep reinforcement learning resources.
* [Awesome Robotics 3D](https://github.com/zubair-irshad/Awesome-Robotics-3D) ⭐ 819 | 🐛 5 | 📅 2025-12-17 - 3D vision for robotics.
* [Awesome Imitation Learning](https://github.com/kristery/Awesome-Imitation-Learning) ⭐ 608 | 🐛 2 | 📅 2024-02-05 - Learning from demonstrations.
* [Bipedal Robot Learning Collection](https://github.com/zita-ch/bipedal-robot-learning-collection) ⭐ 461 | 🐛 2 | 📅 2026-04-06 - Curated bipedal/humanoid robot-learning papers with a sim-to-real focus.
* [Awesome World Models](https://github.com/operator22th/awesome-world-models-for-robots) ⭐ 139 | 🐛 0 | 📅 2026-03-30 - World models for robotics.
* [Awesome AI Scientists](https://github.com/natnew/Awesome-AI-Scientists) ⭐ 16 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-04 - AI scientist systems for literature intelligence, hypothesis generation, experiment planning, and scientific communication.
* [Awesome Agentic AI Security](https://github.com/natnew/Awesome-Agentic-AI-Security) ⭐ 14 | 🐛 6 | 🌐 Astro | 📅 2026-07-24 - Security research, threat models, defenses, and governance for agentic AI systems.
* [Awesome Agentic Engineering](https://github.com/natnew/Awesome-Agentic-Engineering) ⭐ 3 | 🐛 4 | 📅 2026-07-28 - Agentic AI architectures, frameworks, memory, evaluation, and safety.
