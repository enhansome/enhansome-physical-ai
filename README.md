...
Browse [LeRobot](https://github.com/huggingface/lerobot) ⭐ 27,030 | 🐛 833 | 🌐 Python | 📅 2026-08-29 to see how robot datasets, policies, training, and evaluation are structured in practice.
...
* [PyBullet](https://github.com/bulletphysics/bullet3) ⭐ 14,703 | 🐛 424 | 🌐 C++ | 📅 2025-10-22 — Open-source physics engine (Bullet) with Python bindings, popular for prototyping and RL.
...
* [AgiBot World](https://github.com/OpenDriveLab/AgiBot-World) ⭐ 3,159 | 🐛 38 | 🌐 Python | 📅 2026-05-29 — Large-scale dataset designed to train and evaluate robot foundation models.
* [CALVIN ABC-D](https://github.com/mees/calvin) ⭐ 975 | 🐛 52 | 🌐 Python | 📅 2025-09-08 — Language-conditioned manipulation dataset for long-horizon policy training and evaluation.
...
* [ManiSkill Benchmark](https://github.com/haosulab/ManiSkill) ⭐ 3,269 | 🐛 134 | 🌐 Python | 📅 2026-08-04 — Manipulation benchmark suite with scalable GPU simulation and reproducible baselines.
* [CALVIN](https://github.com/mees/calvin) ⭐ 975 | 🐛 52 | 🌐 Python | 📅 2025-09-08 — Benchmark for long-horizon, language-conditioned manipulation.
...
* [LeRobot Evaluation Scripts](https://github.com/huggingface/lerobot) ⭐ 27,030 | 🐛 833 | 🌐 Python | 📅 2026-08-29 — Practical evaluation tooling for imitation-learning and policy-regression checks.
* [Bench2Drive](https://github.com/Thinklab-SJTU/Bench2Drive) ⭐ 1,929 | 🐛 57 | 🌐 Python | 📅 2026-08-11 — Closed-loop evaluation protocol for end-to-end driving policies.
* [nuPlan Devkit](https://github.com/motional/nuplan-devkit) ⭐ 1,029 | 🐛 100 | 🌐 Python | 📅 2025-08-27 — End-to-end planning evaluation stack with documented metrics and simulation loops.
...
* [MuJoCo Menagerie](https://github.com/google-deepmind/mujoco_menagerie) ⭐ 3,887 | 🐛 52 | 🌐 Python | 📅 2026-08-09 — Curated high-quality robot models for repeatable locomotion research.
* [RSL-RL](https://github.com/leggedrobotics/rsl_rl) ⭐ 2,922 | 🐛 11 | 🌐 Python | 📅 2026-08-28 — Fast PPO implementation from ETH Zurich tuned for legged-robot RL on GPU simulators.
...
* [OmniSafe](https://github.com/PKU-Alignment/omnisafe) ⭐ 1,149 | 🐛 29 | 🌐 Python | 📅 2025-03-17 — Open-source safe-RL training framework with strong baseline implementations.
...
* [rosbag2](https://github.com/ros2/rosbag2) ⭐ 435 | 🐛 126 | 🌐 C++ | 📅 2026-08-28 — Standard ROS 2 recording and replay pipeline for debugging and incident analysis.
...
* [LeRobot Tutorials](https://github.com/huggingface/lerobot) ⭐ 27,030 | 🐛 833 | 🌐 Python | 📅 2026-08-29 - Getting started with robot learning using Hugging Face's framework.
...
* [LeRobot Hardware](https://github.com/huggingface/lerobot) ⭐ 27,030 | 🐛 833 | 🌐 Python | 📅 2026-08-29 - Reference designs for low-cost robot arms.
* [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,226 | 🐛 83 | 📅 2026-08-05 - Open-source anthropomorphic robot arm.
...
* [Awesome Generative AI](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,542 | 🐛 613 | 📅 2026-08-03 - Broader generative AI resources.
* [Awesome Robotics](https://github.com/kiloreux/awesome-robotics) ⭐ 6,988 | 🐛 38 | 📅 2024-09-22 - General robotics resources.
* [Awesome LLM Robotics](https://github.com/GT-RIPL/Awesome-LLM-Robotics) ⭐ 4,459 | 🐛 10 | 📅 2026-07-17 - LLM/VLM applications in robotics.
...
* [Awesome Embodied Agent](https://github.com/zchoi/Awesome-Embodied-Robotics-and-Agent) ⭐ 1,860 | 🐛 2 | 📅 2026-08-14 - Embodied AI with VLMs and LLMs.
